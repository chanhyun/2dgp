...
class Bomb:
    ...
    def update(self):#frame about bombanimation
        ...
        if(self.count==5):
            ...
            if(math.sqrt(((cx+65)-self.x+40) *((cx+65)-self.x+40) + ((cy+500)-self.y)*((cy+500)-self.y))<BSIZE+10):
                run=False
                run2=False
                run3=False
                run4=False
                self.count=6
            elif(math.sqrt(((cx-5)-self.x-40) *((cx-5)-self.x-40) + ((cy+500)-self.y)*((cy+500)-self.y))<BSIZE+10):
                run=False
                run2=False
                run3=False
                run4=False
                self.count= 6
            elif(math.sqrt(((cx+40)-self.x) *((cx+40)-self.x) + ((cy+540)-self.y+50)*((cy+540)-self.y+50))<BSIZE+10):
                run=False
                run2=False
                run3=False
                run4=False
                self.count=6
            elif(math.sqrt(((cx+40)-self.x) *((cx+40)-self.x) + ((cy+460)-self.y-50)*((cy+460)-self.y-50))<BSIZE+10):
                run=False
                run2=False
                run3=False
                run4=False
